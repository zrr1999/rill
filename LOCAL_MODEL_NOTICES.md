...
The exact TTS file inventory is defined in `Sources/RillProviders/SpeechSynthesisModelCatalog.swift`. TTS is optional: its worker is started only for a resident TTS model or an active synthesis request.
