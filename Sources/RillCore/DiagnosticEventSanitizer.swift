...
public enum DiagnosticEventSanitizer {
  ...
  private static let eventCodeCatalog: Set<String> = [
    ...
    "provider.local-speech.available",
    "provider.local-speech.recognition.failed",
    "provider.local-speech.recognition.retry",
    "provider.local-speech.unavailable",
    "provider.sherpa-onnx.available",
    "provider.sherpa-onnx.recognition.failed",
    "provider.sherpa-onnx.recognition.retry",
