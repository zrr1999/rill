...
/// Record collection content from growing without bound. Active or leased records
/// are never silently evicted to make room for a new item.
public struct SystemClipboardStorageLimits: Sendable, Equatable {
    public static let productDefault = SystemClipboardStorageLimits(
        ...
        maximumCaptureTagCount: SystemClipboardCaptureTag.allCases.count,
...
public enum SystemClipboardStorageRejectionReason: String, Codable, Error, Sendable, Equatable {
