...
public struct WakeWordSpeechRequest: Sendable {
  public var id: UUID
  public var configuration: SpeechRequestConfiguration
  public init(id: UUID, configuration: SpeechRequestConfiguration) {
    self.id = id
...
public actor WakeWordTriggerSource: TriggerSource {
  ...
  private struct PendingRecognition {
    ...
    let workflow: WakeWordSpeechRequest
    let phrases: [String]
  }
  ...
  private var workflow: WakeWordSpeechRequest?
  ...
  private func recognizeCandidate(
    ...
    do {
      ...
      var speech = workflow.configuration
      speech.isWakeCandidate = true
