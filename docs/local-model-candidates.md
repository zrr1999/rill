...
| `streaming-zipformer-small-bilingual-zh-en-preview-int8` | Fixed live-preview model; not selectable as a final tier | [Streaming Zipformer bilingual INT8](https://github.com/k2-fsa/sherpa-onnx/releases/download/asr-models/sherpa-onnx-streaming-zipformer-small-bilingual-zh-en-2023-02-16.tar.bz2) | `458187351` | `2b7c63322b32e5e0f2526043a1103366119ca58dd615cd7105a37c01db9553d7` | `cea6f98992fd166743ea63ca27ebf87c6b99e11b6d7cf5ae3944e2977dcbfc53` | Native incremental decode passed the archive's 16 kHz fixture on the current arm64 Mac; preview failure degrades to meter-only capture. |
